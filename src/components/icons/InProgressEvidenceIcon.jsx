...
export default function InProgressEvidenceIcon({ className = "w-6 h-6", color = "currentColor" }) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
