                ...
                <thead>
                    <tr className="bg-[#F5F8FB] rounded-[10px]">
                        {documentsTableHeaders.map((header, index) => (
                            <th
                                key={index}
                                className={`py-3 px-4 text-center font-cairo font-normal text-[12px] leading-[22px] text-primary tracking-[0.02em] capitalize ${index === 0 ? 'rounded-l-[10px]' : ''} ${index === documentsTableHeaders.length - 1 ? 'rounded-r-[10px]' : ''}`}
                            >
                    ...
                    {data.map((item, index) => {
                        ...
                        return (
                            <tr key={index} className={index !== data.length - 1 ? "border-b border-border" : ""}>
                                <td className="py-4 px-4 font-cairo text-[14px] text-text-dark text-center">{item.documentNumber}</td>
                                <td className="py-4 px-4 font-cairo text-[14px] text-text-dark text-center">{item.documentName}</td>
                                <td className="py-4 px-4 font-cairo text-[14px] text-text-dark text-center">{item.documentLead}</td>
                                <td className="py-4 px-4 font-cairo text-[14px] text-text-dark text-center">{item.documentPreparer}</td>
                                <td className="py-4 px-4 font-cairo text-[14px] text-text-dark text-center">{item.date}</td>
                                <td className="py-4 px-4 font-cairo text-[14px] text-text-dark text-center">{item.dueDate}</td>
